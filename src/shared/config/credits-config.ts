export default {
	...
	gameplay_designer_credit: { title: "Gameplay Programming", names: ["PeppySpirits"] },
	ui_scripter_credit: { title: "UI Scripter", names: ["PeppySpirits"] },
	ui_designer_credit: { title: "UI Scripter", names: ["PeppySpirits"] },
}
